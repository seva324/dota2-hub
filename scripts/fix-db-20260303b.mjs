...
try {
  // Correct mapping: 1065067 should belong to 1064947.
  await sql.query(`UPDATE matches SET series_id = '1064947' WHERE series_id = '1065067'`);
  await sql.query(`DELETE FROM series WHERE series_id = '1065067'`);

  // Re-aggregate series 1064947 from matches.
  await sql.query(`
    WITH first_match AS (
  ...
  const verify = await sql.query(`
    ...
    FROM series s
    WHERE s.series_id IN ('1064947','1065067')
