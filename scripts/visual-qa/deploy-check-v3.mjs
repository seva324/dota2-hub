...
const cls = await p.evaluate(()=>{const d=document.querySelector('[data-slot="dialog-content"][data-state="open"]');return d?d.className.slice(0,300):'no-modal'});
console.log('Modal:',cls.slice(0,200));
console.log('rounded-xl:',cls.includes('rounded-xl'));
console.log('shadow:',cls.includes('shadow-['));
await b.close();
