...
export const CURATED_TEAM_LOGOS = [
  ...
  buildEntry({
    ...
    teamIds: ['8254145'],
    aliases: ['execration'],
    fileName: 'execration.webp',
    sourceUrl: 'https://s3.dltv.org/uploads/players/tAqJMxaVaSDJ0OZd0Fgecn6PxgWHBEYt.png.webp',
  }),
  buildEntry({
    name: 'Virtus.pro',
    aliases: ['virtuspro'],
    fileName: 'virtus-pro.png',
  ...
  buildEntry({
    ...
    fileName: 'interactive-philippines.svg',
    placeholder: true,
    sourceUrl: '/images/desktop/empty/team.svg',
  }),
  buildEntry({
