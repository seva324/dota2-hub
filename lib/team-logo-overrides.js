export const GITHUB_TEAM_LOGO_BASE_URL = 'https://raw.githubusercontent.com/seva324/dota2-hub/main/public/images/mirror/teams';
...
export const CURATED_TEAM_LOGOS = [
  buildEntry({
    ...
    fileName: "tundra-esports-ranking-dark.png",
  ...
  buildEntry({
    ...
    fileName: "team-yandex-ranking-dark.webp",
  ...
  buildEntry({
    ...
    fileName: "team-liquid-ranking-dark.webp",
  ...
  buildEntry({
    ...
    fileName: "team-falcons-ranking-dark.webp",
  ...
  buildEntry({
    ...
    fileName: "aurora-ranking-dark.png",
    sourceUrl: "https://s3.dltv.org/uploads/teams/medium/2fxCLHnhSIGZE2EGlg1y9HI9X1dgxkZk.png",
  }),
  buildEntry({
    name: "Xtreme Gaming",
    teamIds: ["8261500"],
    aliases: ["xtremegaming","xg","xtreme"],
    fileName: "xtreme-gaming-ranking-dark.webp",
  ...
  buildEntry({
    ...
    fileName: "betboom-team-ranking-dark.webp",
  ...
  buildEntry({
    ...
    fileName: "team-spirit-ranking-dark.webp",
    sourceUrl: "https://s3.dltv.org/uploads/teams/bjSvoovDaI3RlP5J58vn7Gl3rKXK4J8P.png.webp",
  }),
  buildEntry({
    name: "PARIVISION",
    teamIds: ["9572001"],
    aliases: ["parivision","parivisionteam","pari vision","pari"],
    fileName: "parivision-ranking-dark.webp",
  ...
  buildEntry({
    ...
    teamIds: ["9338413"],
    aliases: ["mouz"],
    fileName: "mouz-ranking-dark.png",
  ...
  buildEntry({
    ...
    fileName: "natus-vincere-ranking-dark.webp",
  ...
  buildEntry({
    ...
    teamIds: ["9303484"],
    aliases: ["heroic"],
    fileName: "heroic-ranking-dark.webp",
  ...
  buildEntry({
    ...
    fileName: "vici-gaming-ranking-dark.webp",
  ...
  buildEntry({
    ...
    fileName: "mideng-dreamer-ranking-dark.svg",
    placeholder: true,
    sourceUrl: "/images/desktop/empty/team.svg",
  }),
];
