...
describe('HeroSection live spotlight', () => {
          ...
          json: async () => ({
            live: {
              ...
              maps: [
                ...
                { label: 'Map 3', score: '14 - 11', status: 'live', gameTime: 1738 },
              ],
              liveMap: { label: 'Map 3', score: '14 - 11', status: 'live', gameTime: 1738, team1Score: 14, team2Score: 11 },
              live: true,
              source: 'hawk.live',
            ...
            liveMatches: [
              ...
              },
              {
                ...
                maps: [
                  { label: 'Map 1', score: '12 - 9', status: 'live', gameTime: 620 },
                ],
                liveMap: { label: 'Map 1', score: '12 - 9', status: 'live', gameTime: 620, team1Score: 12, team2Score: 9 },
                live: true,
                source: 'hawk.live',
  ...
  it('renders the live spotlight card and the CN upcoming preview together', async () => {
    ...
    expect(await screen.findByText('5 小时内开赛 · Hawk Live 命中')).toBeInTheDocument();
    ...
    fireEvent.click(screen.getAllByRole('button', { name: /map 1/i })[0]);
  ...
  it('falls back cleanly when the live API returns no match', async () => {
    ...
    expect(screen.queryByText('5 小时内开赛 · Hawk Live 命中')).not.toBeInTheDocument();
    expect(screen.getByText('DreamLeague')).toBeInTheDocument();
  });
});
