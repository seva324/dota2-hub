...
// Get all Chinese team names (lowercase for matching)
export const CHINA_TEAM_NAMES = Object.values(TARGET_TEAMS)
...
export function isChineseTeam(teamName: string | undefined | null): boolean {
  ...
  return CHINA_TEAM_NAMES.some(cn => lower.includes(cn));
}
